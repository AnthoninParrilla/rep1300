...
function mk(){return {classList:{toggle(){},add(){},remove(){}},style:{},attrs:{},setAttribute(){},addEventListener(){},appendChild(){},getBoundingClientRect(){return {left:0,top:0,width:100,height:20};},querySelector(){return mk();},querySelectorAll(){return [];},children:[],dataset:{},value:'10',disabled:false,checked:true,textContent:'',innerHTML:'',onclick:null,closest(){return null},insertBefore(){},removeChild(){},firstChild:null,scrollTop:0,scrollHeight:0,clientHeight:0,scrollWidth:100,scrollIntoView(){}};}
function fresh(){const dn={};global.document={addEventListener:function(){},getElementById(i){if(!ids.has(i))return null;dn[i]=dn[i]||mk();return dn[i];},createElement(){return mk();},createTextNode(){return {};},body:mk()};global.performance={now:()=>0};global.requestAnimationFrame=()=>{};global.navigator={};let s=src0.replace('window.__sim={S:S,physStep:physStep,slowStep:slowStep,trips:trips};','window.__sim={S:S,physStep:physStep,slowStep:slowStep,trips:trips,setEtat:setEtat,recTick:recTick,doScram:doScram};');eval(s);window.__sim.dn=dn;return window.__sim;}
