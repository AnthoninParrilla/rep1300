...
**Mode Facile** : un bouton dans le bandeau active le pupitre formation — un parcours de seize missions guidées avec détection de réussite pousse à tout manipuler soi-même : baisser la charge, réveiller le xénon, diluer, jouer de la source froide, casser et réparer le vide, ouvrir le GCTa, percer la première barrière, appuyer sur le bouton rouge, conduire le repli, guetter le pic xénon, réarmer et re-diverger, descendre jusqu'à l'AN/RRA, survivre à une perte de RRA, puis remonter toute la tranche jusqu'au recouplage. Le pupitre — un guide pas-à-pas qui explique en français courant ce qui se passe et quoi faire (blocage IS, isolement des accumulateurs, admission AN/RRA…), avec un lexique intégré qui traduit tout le jargon (RPE = Réacteur Puisards et Évents, GV = la « bouilloire »…). Les boutons ×60/×300 accélèrent le temps à la demande : la physique reste exacte, l'attente disparaît. **Thème authentique SDC 1300** : adieu le mode sombre — panneaux beige, cadres marron, plaques gravées, boutons khaki, voyants lumineux, et des tuiles d'alarme qui s'allument comme des ampoules sous la dalle. Les écrans (synoptique, chaussette, journal) passent au vert d'automate vieillissant, tracés pixelisés compris. Quinze tests dédiés + les deux bancs au complet avant le numéro de version.

**2.7.0-2.7.2 — la grande session des treize retours.** Seize missions au total (GCTa, première barrière percée puis refermée, pic xénon, re-divergence complète, perte du RRA réparée, et la boucle entière jusqu'au recouplage), un lexique nourri du carnet d'exploitation et de sources vérifiées (23 000 m³/h par GMPP, l'enceinte 120 + 55 cm, les GSS, le poste d'eau ABP/AHP et sa bâche dégazante, les TPA à vapeur vive du barillet), et toute la carrosserie : l'encoche du téléphone respectée (safe-area), des vis dans les angles des panneaux, les cartes espacées sur mobile, le sélecteur de l'enregistreur au thème, les messages d'état justes jusqu'au RCD — et le panache de l'aéroréfrigérant qui brise le quatrième mur, libre de survoler l'alternateur et de sortir du cadre.

**2.6.1-2.6.11 — l'ère de la certification.** Une bulle de valeur au-dessus du pouce sur tous les curseurs, la mission du vide rendue juste (test relatif à la charge, double issue : réflexe ou chaîne de protection subie), les GMPP enfin arrêtées en AN/RRA avec un losange à trois états sur la synoptique, la fenêtre de connexion du RRA [160-180 °C] tranchée par la lecture d'exploitant et codée aux deux bornes, un outil de certification (conformite-figure.js) qui re-vérifie chaque annotation de la figure 4.1 sur chaque build — verdict 15/15 —, la synoptique passée au monochrome vert intégral (l'eau comprise), et les flux fantômes éteints (débit ARE sans TPA, injection aux joints sans GMPP).
